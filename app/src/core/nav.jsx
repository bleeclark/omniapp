        ...
        <div
          ...
          <div className="navbar-start">
            ...
            <a
              ...
              onKeyDown={() => this.navigate(ROUTES.SETTINGS)}>
              Settings
            </a>
            <a
              className="navbar-item"
              onClick={() => this.navigate(ROUTES.NOTIFICATIONS)}
              onKeyDown={() => this.navigate(ROUTES.NOTIFICATIONS)}>
              Notifications
            </a>
            <a
              className="navbar-item"
              onClick={() => this.navigate(ROUTES.CHAT)}
              onKeyDown={() => this.navigate(ROUTES.CHAT)}>
              Chat
            </a>
            <a
              className="navbar-item"
              onClick={() => this.navigate(ROUTES.CONTACT)}
              onKeyDown={() => this.navigate(ROUTES.CONTACT)}>
              Contact
            </a>
